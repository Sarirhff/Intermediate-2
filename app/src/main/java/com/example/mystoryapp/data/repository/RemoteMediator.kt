...
import com.example.mystoryapp.data.database.RemoteKeys
import com.example.mystoryapp.data.response.ListStoryItem
import com.example.mystoryapp.data.retrofit.ApiService

@OptIn(ExperimentalPagingApi::class)
class RemoteMediator (
    private val database: DatabaseUserStory,
        ...
        return try {
            ...
            database.withTransaction {
                if (loadType == LoadType.REFRESH) {
                    ...
                    database.storyUserDao().deleteAllStories()
                }
                ...
                database.storyUserDao().insertAllStories(responseData)
            }
